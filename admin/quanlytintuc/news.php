...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <form class="form-check-inline " action="./index.php?news" method="post">
                                ...
                                if(mysqli_num_rows($result)>0) {
                                    ...
                                    while($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<tr>";
                                            ...
                                            echo "<td><a class='btn btn-danger' href='./index.php?news=delete&id=".$row["new_id"]."'>
            ...
            <h2>Thêm tin tức</h2>
            <!-- form -->
            <form action="./index.php?news" method="post" enctype="multipart/form-data">
